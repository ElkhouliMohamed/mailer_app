    ...
    <div class="container-fluid p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-6">
            <div>
                ...
                <p class="text-md text-secondary-light dark-text-neutral-300 mt-2">Update category details</p>
            </div>
            <a href="{{ route('categories.index') }}" class="btn btn-outline-neutral-600 dark-btn-outline-neutral-400 py-12 px-24 radius-8 fw-semibold text-md d-flex align-items-center gap-2">
        ...
        <div class="card radius-12 shadow-xl bg-white dark-bg-neutral-800 p-5">
            <form method="POST" action="{{ route('categories.update', $category) }}" id="editCategoryForm">
                ...
                @method('PUT')
                <div class="mb-5">
                    <label for="name" class="form-label text-lg fw-medium text-black dark-text-white">Category Name</label>
                    <div class="input-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control radius-8 text-lg py-12" value="{{ old('name', $category->name) }}" required autofocus>
                        @error('name')
                ...
                <div class="d-flex gap-3">
                    ...
                    <a href="{{ route('categories.index') }}" class="btn btn-outline-neutral-600 dark-btn-outline-neutral-400 py-12 px-24 radius-8 fw-semibold text-md">
                        Cancel
                    </a>
                </div>
            </form>
