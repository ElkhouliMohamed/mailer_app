    ...
    <div class="container-fluid p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-6">
            <div>
                ...
                <p class="text-md text-secondary-light dark-text-neutral-300 mt-2">Add a new category for your contacts</p>
            </div>
            ...
            <form method="POST" action="{{ route('categories.store') }}" id="createCategoryForm">
                ...
                <div class="mb-5">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control radius-8 text-lg py-12" value="{{ old('name') }}" required autofocus>
                        @error('name')
