        ...
        <div class="col-auto">
            <div class="d-flex flex-wrap align-items-center gap-3">
                ...
                <button type="button" data-theme-toggle class="w-40-px h-40-px bg-neutral-200 rounded-circle d-flex justify-content-center align-items-center">
                    <iconify-icon icon="solar:moon-linear" class="icon text-xl"></iconify-icon>
                </button>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-lg p-0">
                        ...
                        <div class="max-h-400-px overflow-y-auto scroll-sm pe-4">
                            <a href="{{ route('contacts.index') }}" class="px-24 py-12 d-flex align-items-start gap-3 mb-2 justify-content-between">
                            ...
                            <a href="{{ route('contacts.index') }}" class="px-24 py-12 d-flex align-items-start gap-3 mb-2 justify-content-between bg-neutral-50">
                                <div class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                                    <span class="w-40-px h-40-px rounded-circle flex-shrink-0 position-relative">
                        ...
                        <div class="text-center py-12 px-16">
                            <a href="{{ route('contacts.index') }}" class="text-primary-600 fw-semibold text-md">See All Messages</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-sm">
                        ...
                        <ul class="to-top-list">
                            @auth
                                ...
                                <li>
                                    <a class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-primary d-flex align-items-center gap-3" href="{{ route('contacts.index') }}">
