    ...
    <div class="container-fluid p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-6">
            <div>
                ...
                <p class="text-md text-secondary-light dark-text-neutral-300 mt-2">Configure your email settings</p>
            </div>
        ...
        <div class="card radius-12 shadow-xl bg-white dark-bg-neutral-800 p-5">
            <form method="POST" action="{{ route('smtp_settings.update', $smtpSetting) }}" id="smtpSettingsForm">
                @csrf
                @method('PATCH')
                ...
                <div class="mb-5">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="host" id="host" class="form-control radius-8 text-lg py-12" value="{{ old('host', $smtpSetting->host) }}" required>
                        @error('host')
                ...
                <div class="mb-5">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="port" id="port" class="form-control radius-8 text-lg py-12" value="{{ old('port', $smtpSetting->port) }}" required min="1" max="65535">
                        @error('port')
                        <span class="text-danger dark-text-danger-300 text-sm mt-2">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="username" id="username" class="form-control radius-8 text-lg py-12" value="{{ old('username', $smtpSetting->username) }}" required>
                        @error('username')
                        <span class="text-danger dark-text-danger-300 text-sm mt-2">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" name="password" id="password" class="form-control radius-8 text-lg py-12" value="{{ old('password', $smtpSetting->password) }}" required>
                        @error('password')
                        <span class="text-danger dark-text-danger-300 text-sm mt-2">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="sender_name" id="sender_name" class="form-control radius-8 text-lg py-12" value="{{ old('sender_name', $smtpSetting->sender_name) }}" required>
                        @error('sender_name')
                        <span class="text-danger dark-text-danger-300 text-sm mt-2">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="sender_email" id="sender_email" class="form-control radius-8 text-lg py-12" value="{{ old('sender_email', $smtpSetting->sender_email) }}" required>
                        @error('sender_email')
                        <span class="text-danger dark-text-danger-300 text-sm mt-2">{{ $message }}</span>
                        @enderror
                    </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                form.addEventListener('submit', function(e) {
                    ...
                    Swal.fire({
                        title: 'Are you sure?',
                        text: 'Do you want to update these SMTP settings?',
                        icon: 'question',
